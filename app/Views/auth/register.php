...
<div class="card shadow-sm" style="width:100%;max-width:400px">
    <div class="card-body p-4">
        ...
        <form method="POST" action="/register">
            ...
            <div class="mb-3">
                <label class="form-label">Пароль <small class="text-muted">(минимум 6 символов)</small></label>
                <input type="password" name="password" class="form-control" required minlength="6">
            </div>
            <button type="submit" class="btn btn-dark w-100">Зарегистрироваться</button>
        </form>
        <p class="mt-3 mb-0 text-center small">Уже есть аккаунт? <a href="/login">Войти</a></p>
    </div>
</div>
</body>
</html>
