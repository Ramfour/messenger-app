...
<head>
    ...
    <title>Профиль — Мессенджер</title>
    ...
    <div class="card-body p-4">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            <img src="<?= htmlspecialchars($user['avatar'] ?? '/img/default-avatar.svg', ENT_QUOTES, 'UTF-8') ?>"
                 class="rounded-circle" width="72" height="72" style="object-fit:cover" alt="Аватар">
        ...
        <form method="POST" action="/profile">
            ...
            <div class="mb-3 form-check">
                ...
                <label class="form-check-label" for="emailHidden">Скрыть email из поиска</label>
            </div>
            <button type="submit" class="btn btn-dark w-100">Сохранить</button>
        </form>
        <div class="mt-3 text-center">
            <a href="/chats" class="small">&larr; Назад к чатам</a>
        </div>
    </div>
</div>
<script>
